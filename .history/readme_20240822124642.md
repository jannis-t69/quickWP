...
QuickWP is on docker and mend for spinning up a WordPress test site. Can be used for debugging or testing of plugins and themes before production roll out.
