...
Usually standard port 80 is busy with other For docker port-forwarding other the defaul following two settings must be set for wp-config.php if the http port is not port 80
