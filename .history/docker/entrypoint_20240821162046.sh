...
sed -i 's/upload_max_filesize = 2M/upload_max_filesize = 256M/g' /etc/php/8.2/fpm/php.ini
sed -i 's/post_max_size = 8M/post_max_size = 256M/g' /etc/php/8.2/fpm/php.ini
