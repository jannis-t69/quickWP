...
{}
echo "INSTANTWP_URL=$INSTANTWP_URL" > docker/.env
echo "INSTANTWP_PLUGINS=$INSTANTWP_PLUGINS" >> docker/.env
echo "INSTANTWP_LOCALE=$INSTANTWP_LOCALE" >> docker/.env
echo "INSTANTWP_REINSTALL=$INSTANTWP_REINSTALL" >> docker/.env
echo "INSTANTWP_PORT=$INSTANTWP_PORT" >> docker/.env
} >> .docker/.env
