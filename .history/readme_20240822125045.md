...
- Run `./quichwp`
- After container deployment open youbrowser with the parameter specified for http://<IP/Domain>:<forwarded host-Port> or the default ones set in instantwp.sh
