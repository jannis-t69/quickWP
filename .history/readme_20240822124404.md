...
QuickWP is based on docker for spinning up a WordPress test site. Can be used for debugging or testing of plugins and themes before production roll out.
